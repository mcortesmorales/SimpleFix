...
const VisualizePage = () => {
  ...
  const card = { 
    ...
    text: "Lista completa de los trabajadores y sus horarios.", 
    icon: <FaCopy size={35} />, 
    buttonText: "Ver", 
    onClick: () => navigate('/trabajadores') // Navega a la herramienta de corrección en /repair-tool
  };

  return (
    <div className="d-flex flex-column align-items-center justify-content-center vh-100 p-5">
      <h2 className="text-center mb-5">Herramientas de Visualizacion</h2>
